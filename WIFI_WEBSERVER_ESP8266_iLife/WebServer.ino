      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<H1 style='font-size:400%;'>iLife Vacuum Control</H1>");
            ...
            if (isAwake()) {
              ...
              if (isRunning()) {
                client.println("<br />");
                client.println("<H3 style='font-size:100%;'>iLife Vacuum is CLEANING</H3>");
              }
              else {
                client.println("<br />");
                client.println("<H3 style='font-size:100%;'>iLife Vacuum is ON but not cleaning</H3>");
              }
            }
            else {
              client.println("<H3 style='font-size:100%;'>iLife Vacuum in SLEEP MODE</H3>");
            }
            if (wakingup && !isAwake()) {
              client.println("<br />");
              client.println("<H3 style='font-size:100%;'>Waking up iLife Vacuum</H3>");
            }
            else if (isAwake() && !isRunning()) {
              client.println("<br />");
              client.println("<H3 style='font-size:100%;'>iLife Vacuum is AWAKE</H3>");
            }
            ...
            client.println("<br />");
            client.println("<a href=\"/boot\"\"><button style='font-size:170%; background-color:darkgray; color:green;border-radius:50px; position:center; top:530px; left:300px;'>  RESTART iLife Vacuum </button></a>");
            ...
            client.println("<br />");
            client.println("<a href=\"/Prepare\"\"><button style='font-size:170%; background-color:darkgray; color:green;border-radius:50px; position:center; top:530px; left:300px;'>   Prep controller for OTA</button></a>");
        ...
        if (currentLine.endsWith("GET /Prepare")) {
