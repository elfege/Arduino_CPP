  ...
  <html>
    <head>      
      <table style="width:100%">
        <tr>         
         <center><th><h1 style=color:blue;><center>WINDOW OFFICE NORTH</center></h1></th></center>         
        </tr>
      </table>
  ...
  <body>
    ...
    <table style="width:100%">
     ...
     <tr>      
      ...
      <iframe width="800" height="500" src="http://192.168.10.206/term.html" title="Serial Terminal Output" style="border:1px solid black;">
      </iframe>
      <p> 
       <table style="width:100%">
        <tr>
