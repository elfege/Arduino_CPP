const char MAIN_page[] PROGMEM = R"=====(
  <html>
    <head>
      <center>
        <h1 style=color:blue;><center>CURTAINS BEDROOM</center></h1>
  ...
  <body onload="REFRESH()">
    <center>
    <div>
      <button id="OPEN" style=width:100px;height:45px;margin-left:0;color:white;background-color:blue onclick="MainFunc('/open', id)"> OPEN </button>
      <button id="CLOSE" style=width:100px;height:45px;margin-left:0;color:white;background-color:blue onclick="MainFunc('/close', id)"> CLOSE </button>
