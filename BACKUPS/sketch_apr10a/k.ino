...
<body onload="UpdateValues()">
  <table style="width:100%;text-align: center;">
    ...
    <tr>
      ...
      <button id="stop" style=width:100px;height:45px;margin-left:0;color:white;background-color:grey onclick="MainFunc('/stop', id)"> STOP </button>
      ...
      <td>
      <script type="text/javascript" src="http://www.ispyconnect.com/external_viewer2.aspx?id=ANk9M1sYEUKt%2fLk7JWqG0AegfmPwgD6JLwV5jKli2r4%2bLReVgjJsheE29YBDthawDl%2fvvrvIhz8QVOenPXrX9ScUszimRL98myShFmEf%2bZLky3%2bMM6SiwjAj8QUeqqODNSLtubbOSDpTBBNfr6k2BQ%3d%3d"></script>
