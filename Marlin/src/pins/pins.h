...
#elif MB(TH3D_WIFI_SSID2OARD)
  #include "lpc1769/pins_TH3D_WIFI_SSID2OARD.h"        // LPC1769                                env:LPC1769
...
#elif MB(TH3D_WIFI_SSID2OARD_LITE_V2)
  #include "stm32f4/pins_TH3D_WIFI_SSID2OARD_LITE_V2.h" // STM32F4                               env:TH3D_WIFI_SSID2oard_Lite_V2
#elif MB(INDEX_REV03)
