...
boolean IsACmd() {
  if (currentLine.equals("GET /FWD") || currentLine.equals("GET /RVS") || currentLine.equals("GET /STOP") || currentLine.equals("GET /ON") || currentLine.equals("GET /OFF") || currentLine.equals("GET /RunATest") ||
      currentLine.equals("GET /LEFT") || currentLine.equals("GET /RIGHT") || currentLine.equals("GET /AUTO") || currentLine.equals("GET /pureFD") || currentLine.equals("GET /simpleRV") || currentLine.equals("GET /charge") ||
      currentLine.equals("GET /stopcharge") || currentLine.equals("GET /dock") || currentLine.equals("GET /SearchStation") || currentLine.equals("GET /FollowLineFWD") || currentLine.equals("GET /FollowLineRVS") || currentLine.equals("GET /AllowOTA") ||
      currentLine.equals("GET /logs") || currentLine.equals("GET /POWERON") || currentLine.equals("GET /POWEROFF") || currentLine.equals("GET /init")) {
    Serial << "THIS IS A COMMAND!!!!!!!!!!!!!!!!!!!!" << endl;
    return false;
  }
  else {
    Serial << "NOT A COMMAND-----------------------------------------" << endl;
    return true;
