...
boolean encodersOk = true; // false is you don't want encoders based speed adjustments despite going forward or reverse (mvt = true)
...
boolean useSignal = false; // for reverse line following
...
int clrec = 0; // cl and cr parallel counters
int crrec = 0;
