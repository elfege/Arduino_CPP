...
const char* ssidChar = "ELFEGE";     //adjust to your own values
const char* passwordChar = "ReUss!Gahsh4479#$"; //adjust to your own values
...
IPAddress secondaryDNS(192, 168, 10, 1);
