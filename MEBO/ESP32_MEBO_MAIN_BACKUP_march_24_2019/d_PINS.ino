...
#define LineLeftRear           33 // rear left color and line detector
#define LineRightRear          32 // rear right color and line detector 
...
#define ROTARY_ENCODER_RIGHT_PIN 26
#define ROTARY_ENCODER_LEFT_PIN 25
