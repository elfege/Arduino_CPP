    ...
    <tr>
      <td>
        <table style=width:100%;>
         ...
         <th style=border:0px>
          <td style=border:0px>
           <button id="logs"   onclick="MainFunc('/logs', id)"> LOGS </button>
           <button id="dock"   onclick="MainFunc('/dock', id)"> DOCK </button>
           <p></p>
           <button id="logsATmega" style="width:160;hight:60"; onclick="MainFunc('/logsAtmega', id)"> STOP LOGS ON ATmega</button>
          </td>
         </th>
       </table> 
      </td> 
