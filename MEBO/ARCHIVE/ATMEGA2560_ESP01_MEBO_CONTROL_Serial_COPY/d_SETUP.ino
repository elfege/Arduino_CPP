...
void setup()
{
  ...
  //Serial.begin(115200); // serial print out / debug
  Serial1.begin(115200); // com with ESP01 for Wifi communication wit AT firmware on ESP01
  Serial2.begin(115200); // com with ESP8266 12E
