...
<html>
  <head>
    <script type="text/javascript" src="http://www.ispyconnect.com/external_viewer2.aspx?id=ANk9M1sYEUKt%2fLk7JWqG0AegfmPwgD6JLwV5jKli2r4%2bLReVgjJsheE29YBDthaw4mLJ3%2b4nxhNnpOke7XTsWibE5kvCYrU%2bzvat%2fzZiWri476z46qs%2bqs32qVIJKYpRBK3Sce9YhFlSV%2fM3JUAj8Q%3d%3d"></script>
    </script>
    <center>
    <button id"stopall" style=width:100px;height:45px;margin-left:0;color:white;background-color:orange onclick="MainFunc('/stopall', 'MVT-state')"> STOP ALL! </button>
  ...
  <table style="width:100%;text-align: center;">
    ...
    <tr>
      <td>
          ...
          <div>
            <p>
              <button style=width:100px;height:45px;margin-left:0 onclick="MainFunc('/left', 'MVT-state')"> < </button>
                <button style=width:100px;height:45px;margin-left:0;color:white;background-color:red onclick="MainFunc('/stop', 'MVT-state')"> STOP </button>
        ...
        <p> 
        <button style=width:100px;height:45px;margin-left:0;color:white;background-color:navy blue onclick="MainFunc('/followlinefwd', 'MVT-state')"> Follow line FWD </button>
      ...
      <td> 
        ...
        <tr>
          ...
          <td>
            <p><button style=width:100px;height:45px;margin-left:0 id="roamingstate" onclick="MainFunc('/selfdrive', 'MVT-state')"> Roam </button></p>
          </td>
        </tr>
  </table>
<p>
