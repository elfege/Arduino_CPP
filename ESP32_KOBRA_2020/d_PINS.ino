...
#define MotorsPw   23 // power to motors and cameras

#define ENABLE_LEFT         19  //right speed modulation 
#define MOTOR_RIGHT1        18  //right motor
#define MOTOR_RIGHT2        27

#define MOTOR_LEFT1         17 // left motor 
#define MOTOR_LEFT2         16
#define ENABLE_RIGHT        4 //left speed modulation 

#define TRACK_MOTOR_A       22
...
#define LED                 2 // on board buil-in led

/***********INPUT PINS*********************/
#define contactClamp           39 
const int LineLeftFront = 34; // front left color and line detector
const int LineRightFront = 35; // front right color and line detector
const int PW = 36; // charging and battery current measurment GPIO36 

/*
https://randomnerdtutorials.com/esp32-pinout-reference-gpios/

GPIOs 35 to 39 are GPIOs – input only pins. These pins don’t have internal pull-ups or pull-down resistors.
