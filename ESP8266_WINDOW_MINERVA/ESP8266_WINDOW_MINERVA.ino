...
// NTP server
//World
//char timeServer[] = "time.nist.gov"; // ELFEGE: ping fails for this one... 
// Canada
...
int reset_counter;
int resetClosingSpeed = 600; // this is the default value after a cold reset (power off/on)
int CLOSINGSPEED; // will be updated by learning process // we want to keep these values after reset
int ULTRASLOW; // this needs to be learned at time of first closing
int FIRSTPUSH;  // learned during first opening
int ULTRASLOW_RESTORE = 600;
int lastOperation;
int lastSpeedVal;
int program_step;
int openLearn; // can't be boolean
int closeLearn;
int successfulOpenLearn;
int successfulCloseLearn;
int donotAcceptCmdsFromHubs;
int method_1_Failed; // pseudo bool
int failSafeBoot;
