  ...
  <html>
    <head>      
      <table style="width:100%">
        <tr>         
         <center><th><h1 style=color:blue;><center>WINDOW MINERVA</center></h1></th></center>         
        </tr>
      </table>
  ...
  <body>
    ...
    <table style="width:100%">
        <tr>
          ...
          <th> <button id="FORCESTOP" style=width:100px;height:45px;margin-left:0;color:white;background-color:red onclick="MainFunc('/forcestop', id)"> EM. STOP!</button></th> 
          ...
          <th> <button id="RTCRESET" style=width:100px;height:45px;margin-left:0;color:white;background-color:grey onclick="MainFunc('/rtcreset', id)">RTC RESET</button></th>
          ...
          <th> <button id="FAILSAFEBOOT" style=width:100px;height:45px;margin-left:0;color:white;background-color:grey onclick="MainFunc('/failsafe', id)">FAIL SAFE BOOT</button></th> 
          <th> <button id="LEARNPLUS" style=width:45px;height:45px;margin-left:0;color:white;background-color:grey onclick="MainFunc('/learnplus', id)">L+</button></th> 
          <th> <button id="LEARNMINUS" style=width:45px;height:45px;margin-left:0;color:white;background-color:grey onclick="MainFunc('/learnminus', id)">L-</button></th> 
        </tr>
    </table>
    <div class="slidecontainer">
      <p></p>
      <h8 style=color:red; >SPEED: <span id="speed"></span>  &nbsp  &nbsp </h8>
      <div> <input type="range" min="0" max="100" value="0" class="slider" width="400" id="speedRange" onmouseup="sendSlider(id, value)"> </div>
    </div>

      <iframe width="800" height="500" src="http://192.168.10.205/term.html" title="Serial Terminal Output" style="border:1px solid black;">
      </iframe>
      <p> 
       <table style="width:100%">
        <tr>
          ...
          <th><iframe width="500" height="100" src="http://192.168.10.203/index2" title="Windows Office South" style="border:1px solid black;">
          </iframe></th>
         </tr>
         <tr>
          <th><iframe width="500" height="100" src="http://192.168.10.207/index2" title="Windows Bedroom" style="border:1px solid black;">
          </iframe></th>
          <th><iframe width="500" height="100" src="http://192.168.10.206/index2" title="Windows Minerva" style="border:1px solid black;">
          </iframe></th>
        </tr>
       </table>
     </p> 
  ...
  <script>
     ...
     function checkReload() 
    {
      ...
      xhr.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          console.log(xhr.responseText);
          if(xhr.responseText == "reloadthepage")
          {
     ...
     function getClockInfo(){
      ...
      var interval4 = setInterval(function(){getTimeInfo();}, 1000);
      var interval5 = setInterval(function(){getClockInfo();}, 500);
      var interval6 = setInterval(function(){checkReload();}, 100); // this one must be fast
