      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<H1 style='font-size:300%;color:yellow';>Cat's Water Tank</H1>");
            
            client.println("<H1 style='font-size:300%;color:yellow';>Mac Address: </H1>");
            ...
            client.println("<br />");
            if (Running) {
              client.println("<H3 style='font-size:100%;color:yellow';>PUMP IS RUNNING</H3>");
            }
            else {
              client.println("<H3 style='font-size:100%;color:white';>PUMP IS OFF</H3>");
            }
