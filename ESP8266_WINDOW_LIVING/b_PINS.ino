...
#define contact_sensor      D6 // interrupt
#define armMov              D7 // interrupt

// motor control // must be VARIABLES, not constants
int pwm = D2; //D5 // speed modulation D1 or D2 depending on direction (not H-Bridge)
int motorclose = D2; // motor
int motoropen = D1; // motor
