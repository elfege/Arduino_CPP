const char MAIN_page[] PROGMEM = R"=====(
  <html>
    <head>      
      <table style="width:100%">
        <tr>         
         <center><th><h1 style=color:blue;><center>WINDOW LIVING</center></h1></th></center>         
        </tr>
      </table>
  ...
  <body>
    ...
    <table style="width:100%">
     ...
     <tr>      
      ...
      <iframe width="800" height="500" src="http://192.168.10.204/term.html" title="Serial Terminal Output" style="border:1px solid black;">
      </iframe>
      <p> 
       <table style="width:100%">
        <tr>
          <th><iframe width="500" height="100" src="http://192.168.10.206/index2" title="Windows Living" style="border:1px solid black;">
          </iframe></th>
  ...
  <script>
    ...
    getSpeedValue(); // must run before below definitions at load()
    ...
    slider.oninput = function() {
      ...
      output.value = slider.value; // update the slider position
      //getSpeedValue(); // don't run it from here because it'll restore the old value before the server had time to set the new value. Let the scheduled interval take care of this
    }  
     ...
     function checkReload() 
    {
     ...
     function getClockInfo(){
      ...
      var interval2 = setInterval(function(){getSpeedValue();}, 1000);
