      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<H1 style='font-size:400%;color:yellow';>AC BEDROOM</H1>");
            client.println("<br />");

            if(isOn){
              client.println("<H3 style='font-size:400%;color:yellow';>ON</H3>");
            }
            else {
              client.println("<H3 style='font-size:400%;color:yellow';>OFF</H3>");
            }
        ...
        if (currentLine.endsWith("GET /R")) {
          ...
          String StringWifi = WiFi.localIP().toString();
          String url1 = "<meta http-equiv='refresh' content='20; url=http://";
          String url2 = "'/>";
          String UrlFinal = url1 + StringWifi + url2 ;
