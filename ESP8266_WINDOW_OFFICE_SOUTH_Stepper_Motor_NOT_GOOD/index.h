const char MAIN_page[] PROGMEM = R"=====(
  <html>
    <head>
      <center>
        <h1 style=color:blue;><center>WINDOW OFFICE SOUTH</center></h1>
  ...
  <script>
    ...
    function getState() 
    {
      ...
      var interval2 = setInterval(function(){displayspeedValue();}, 30000);
      var interval3 = setInterval(function(){getDebug();}, 30000);
