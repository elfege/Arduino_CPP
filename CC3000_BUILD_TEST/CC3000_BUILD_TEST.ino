...
#define WLAN_SSID       "ELFEGE"        // cannot be longer than 32 characters!
#define WLAN_PASS       "ReUss!Gahsh4479#$"        // don't want to share my password with everybody!
...
void setup(void)
{
  ...
  uint8_t macAddress[6] = { 0x08, 0x00, 0x28, 0x01, 0xD9, 0xB8 };
  ...
  */
  ...
  uint32_t ipAddress = cc3000.IP2U32(192, 168, 10, 208);
  uint32_t netMask = cc3000.IP2U32(255, 255, 255, 0);
  uint32_t defaultGateway = cc3000.IP2U32(192, 168, 10, 1);
  uint32_t dns = cc3000.IP2U32(192, 168, 10, 1);
...
void listSSIDResults(void)
{
  ...
  index = cc3000.startSSIDscan(&index);
