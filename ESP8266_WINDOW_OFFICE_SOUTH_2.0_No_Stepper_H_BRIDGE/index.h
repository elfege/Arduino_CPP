const char MAIN_page[] PROGMEM = R"=====(
  <html>
    <head>      
      <table style="width:100%">
        <tr>         
         <center><th><h1 style=color:blue;><center>WINDOW OFFICE SOUTH</center></h1></th></center>         
        </tr>
      </table>
  ...
  <body>
   ...
   <iframe width="800" height="500" src="http://192.168.10.203/term.html" title="Serial Terminal Output" style="border:1px solid black;">
      </iframe>
      <p> 
       <table style="width:100%">
        <tr>
