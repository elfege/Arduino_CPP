...
#define feeder                    12  // signal to run the motor through a simple relay

#define sensor                    A3 // GPIO39
#define RESET_PIN                 32 //  // no longer in use // pin connected to a PNP557 transistor to trigger physical RST 
