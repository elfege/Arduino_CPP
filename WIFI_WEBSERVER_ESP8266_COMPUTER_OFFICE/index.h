    ...
    <tr>
      <td>
        ...
        <button id="powerstatus" style=width:100px;height:45px;margin-left:0;color:white;background-color:red onclick="MainFunc('/togglepower', id)"> SWITCH </button>
         <p></p>
         <button id="powerstatus" style=width:100px;height:45px;margin-left:0;color:white;background-color:red onclick="MainFunc('/hardreboot', id)"> HARD REBOOT </button>
         <p></p>
         <button id="powerstatus" style=width:100px;height:45px;margin-left:0;color:white;background-color:red onclick="MainFunc('/shutdown', id)"> SHUTDOWN </button>
        <p>
        <button id="reboot" style=width:100px;height:45px;margin-left:0;color:white;background-color:darkblue onclick="MainFunc('/ignore', id)"> ignore </button>
        </p>
      </td>
      <td>
