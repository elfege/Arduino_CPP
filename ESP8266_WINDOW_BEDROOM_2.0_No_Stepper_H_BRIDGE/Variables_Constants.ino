...
String previousDebugDataCmd_ss = "";
...
int ULTRASLOW_RESTORE = ULTRASLOW; // DEPRECATED March 2022 //value to be restored after the program had to increase default speed (deprecated, using FINALSPEED instead)
int SLOW = 700;
int FAST = 1023;
