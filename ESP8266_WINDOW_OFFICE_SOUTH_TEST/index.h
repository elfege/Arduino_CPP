const char MAIN_page[] PROGMEM = R"=====(
  <html>
    <head>
      <table style="width:100%">
        <tr>         
         <center><th><h1 style=color:blue;><center>WINDOW BEDROOM</center></h1></th></center>         
        </tr>
      </table>
  ...
  <body>
    ...
    <div class="slidecontainer">
      ...
      <iframe width="800" height="300" src="http://192.168.10.207/term.html" title="Serial Terminal Output" style="border:1px solid black;">
      </iframe>
      <p> 
       <table style="width:100%">
        <tr>
         ...
         <tr>
          <th><iframe width="500" height="100" src="http://192.168.10.204/index2" title="Windows Bedroom" style="border:1px solid black;">
          </iframe></th>
  ...
  <script>
    ...
    function getState() 
    {
     ...
     function getClockInfo(){
      ...
      var interval2 = setInterval(function(){getSpeedValue();}, 30000);
