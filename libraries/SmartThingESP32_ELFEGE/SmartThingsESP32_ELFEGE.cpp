...
namespace st
{
	...
	st_server(serverPort)
	{
		...
		//*******************************************************************************
		// SmartThingsESP32_ELFEGE Constructor - DHCP
		//*******************************************************************************
	SmartThingsESP32_ELFEGE::SmartThingsESP32_ELFEGE(String ssid, String password, uint16_t serverPort, IPAddress hubIP, uint16_t hubPort, SmartThingsCallout_t *callout, String shieldType, bool enableDebug, int transmitInterval) :
	...
	st_server(serverPort)
	{
		...
		// SmartThingsESP32_ELFEGE Constructor - DHCP
		//*******************************************************************************
	SmartThingsESP32_ELFEGE::SmartThingsESP32_ELFEGE(uint16_t serverPort, IPAddress hubIP, uint16_t hubPort, SmartThingsCallout_t *callout, String shieldType, bool enableDebug, int transmitInterval) :
	SmartThingsEthernet(serverPort, hubIP, hubPort, callout, shieldType, enableDebug, transmitInterval, true),
	st_server(serverPort)
	{
		...
		//*****************************************************************************
		//SmartThingsESP32_ELFEGE::~SmartThingsESP32_ELFEGE()
		//*****************************************************************************
	SmartThingsESP32_ELFEGE::~SmartThingsESP32_ELFEGE()
	{
		...
		//**************************************************************************************
	void SmartThingsESP32_ELFEGE::WiFiEvent(WiFiEvent_t event)
	{
		...
		//*******************************************************************************
		/// Initialize SmartThingsESP32_ELFEGE Library
		//*******************************************************************************
	void SmartThingsESP32_ELFEGE::init(void)
	{
		  // delete old config
		WiFi.disconnect(true);
		delay(1000);
		WiFi.onEvent(SmartThingsESP32_ELFEGE::WiFiEvent);
		...
		Serial.println(F(""));
		Serial.println(F("SmartThingsESP32_ELFEGE: Intialized"));
		Serial.println(F(""));
		...
		//*****************************************************************************
		// Run SmartThingsESP32_ELFEGE Library
		//*****************************************************************************
	void SmartThingsESP32_ELFEGE::run(void)
	{
		String readString;
		String tempString;
		String strRSSI;
	...
	if (tempString.length() > 0)
	{
		...
		//*******************************************************************************
	void SmartThingsESP32_ELFEGE::send(String message)
	{
	...
	void SmartThingsESP32_ELFEGE::Reconnect(void)
	{
		int count = 0;
		if (WiFi.status() != WL_CONNECTED)
		{
