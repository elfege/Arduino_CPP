...
namespace st
{
	class SmartThingsESP8266WiFi_DUAL_SSID_3_HUBS: public SmartThingsEthernet_DUAL_SSID_3_HUBS
	{
	private:
	...
	public:
		...
		///   @param[in] enableDebug (optional) - Enable internal Library debug
		//*******************************************************************************
		SmartThingsESP8266WiFi_DUAL_SSID_3_HUBS(uint16_t serverPort, IPAddress hubIP, uint16_t hubPort, IPAddress hubIP2, uint16_t hubPortb, IPAddress hubIP3, uint16_t hubPortc, SmartThingsCallout_t *callout, String shieldType = "ESP8266Wifi", bool enableDebug = false, int transmitInterval = 100);
		...
		virtual void waitForResponse(IPAddress ipclient);
