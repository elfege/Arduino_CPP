...
#ifndef __SmartThingsEthernet_DUAL_SSID_3_HUBS_H__ 
#define __SmartThingsEthernet_DUAL_SSID_3_HUBS_H__
...
namespace st
{
	class SmartThingsEthernet_DUAL_SSID_3_HUBS: public SmartThings
	{
	private:
	...
	public:
		...
		///   @param[in] enableDebug (optional) - Enable internal Library debug
		//*******************************************************************************
		SmartThingsEthernet_DUAL_SSID_3_HUBS(uint16_t serverPort, IPAddress hubIP, uint16_t hubPort, IPAddress hubIP2, uint16_t hubPortb, IPAddress hubIP3, uint16_t hubPortc, SmartThingsCallout_t *callout, String shieldType = "EthernetShield", bool enableDebug = false, int transmitInterval = 100, bool DHCP = true);
