...
int const CanOnTrackSensor = A2; // Distance Sensor Analog input detects Arm's proximity
...
Serial.begin(9600);
  ...
  Console.println("Attaching Servos");
  Lift.attach(26);
  Gate.attach(27);
  ...
  delay(50);
  Console.println("Positioning Servos");
    ...
    while (client.connected()) {            // loop while the client's connected
      if (client) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {
          ...
          Console.println("");
          Console.print("currentLine: "); Console.print(currentLine);//see what was captured
          ...
          client.print(F(
                         ...
                         "<input type=submit value='Serve Food' style=width:120px;height:30px onClick=location.href='/gogetcan'>"
          ...
          delay(1);
          client.stop();
          Console.println("client disonnected");

          // Check request:
          Console.println("READING COMMAND: "); Console.print(currentLine);
          if (currentLine.startsWith("GET /on")) {
            ...
            count = 0;
            while (count < 10) {
              Console.println("SPIN TEST");
              delay(1000);
              count++;
            }
            Spin.write(90);
            Spin2.write(90);
            Console.println("SPIN TEST TERMINATED");
          }
            ...
            Console.println("LOCK COMMAND SENT");
            Lift.write(LiftDown);
            delay(1000);
            Lock();
          }
          else if (currentLine.startsWith("GET /Unlock")) {
            Console.println("UNLOCK COMMAND SENT");
            LiftItUp();
            ...
            Console.println("towerleft COMMAND SENT");

            Tower.write(TowerLeft);
          }
          else if (currentLine.startsWith("GET /towerright")) {
            Console.println("towerright COMMAND SENT");
            ...
            Console.println("");
            Console.print("Current arm pos = "); Console.print(current);
            Console.println("");
            Console.print("Current Increment Val = "); Console.print(increment);
            int newpos = current + increment;
            Arm.write(newpos);
            Console.println("");
            Console.print("New arm pos = "); Console.print(Arm.read());
            ...
            increment = 1;
            Console.println("");
            Console.print("New Increment Val = "); Console.print(increment);
          }
          ...
          Console.println("String CLEARED");
          currentLine = "";
...
void GrabIt() {
  ...
  while (!candetected()) {
    ...
    int DesiredArmPos = ArmCatch;
    int ArmPosStart = ArmDown;
    ...
    while (Tower.read() > 20 ) {
      ...
      TowerPos--;
      Console.println("");
      Console.print("TowerPos = "); Console.print(TowerPos);
      Tower.write(TowerPos);
      delay(100);
      ...
      if (Arm.read() > DesiredArmPos) {
        ...
        Console.println("");
        Console.print("ArmNewPos = "); Console.print(ArmNewPos);
      ...
      if (Tower.read() <= 30) {
        ...
        Clamp.write(ClampClosed); // important to release pressure on the servo
        delay(500);
    ...
    if (countFailed > 1) {
      Console.println("TOTAL FAILURE, program stoped");
...
{
  Console.println("");
  Console.print("DesiredPosDegrees converted");
  Console.println("");
...
void RunServoTower() {
  ...
  while (Tower.read() < DesiredPos) {
    ...
    Tower.write(pos);
    delay(Speed);
    //Console.println("LiftLoop1");
  }
  while (Tower.read() > DesiredPos) {
    pos--;
    Tower.write(pos);
    delay(Speed);
    //Console.println("LiftLoop2");
  }
  ServoIsDone = true;
}
...
boolean CanIsOnTrack() {
  ...
  if (analogRead(CanOnTrackSensor) < 100) {
    result = true;
    Console.println("");
    Console.print("CAN ONTO TRACK");
  }
  else {
    result = false;
    Console.println("");
    Console.print("NO CAN ON TRACK");
  }
  Console.println("");

  /*
    Console.println("");
    Console.print("DistanceSensor Read: "); Console.print(analogRead(DistanceSensor));
  */
  return result;
}
...
void Reset() {
  ...
  Console.println("client disonnected");
  Console.println("");
  Console.print("Reseting in 3 seconds");
  delay(3000);
  resetFunc();
}
...
void PingTest() {
  ...
  Console.println("TimeB4Ping = when total millis will reach : "); Console.print(TimeB4Ping);
...
void RunServoArm_MS() {
  ...
  Console.println("");
  Console.print(" BEFORE CONVERSION = "); Console.print(DesiredPosDegrees);
  DesiredPos = degree2ms(DesiredPosDegrees); // convert DesiredPosDegrees from degrees to microseconds (0-270 / 500-2500)
  Console.println("");
  Console.print(" AFTER CONVERSION = "); Console.print(DesiredPos);
  delay(10);
  while (ArmPos > DesiredPos) {
    Console.println("");
    Console.print("ArmRead= "); Console.print(Arm.read());
    Console.println("");
    Console.print("ArmPos = "); Console.print(ArmPos);
  ...
  while (a == 0) {
    ...
    if (!CanPresence()) {
      ...
      while (CanPresence() && count < 4) {
        ...
        Console.println("");
        Console.print("CanPresenceSensor1: ");  Console.print(read1);
        Console.println("");
        Console.print("CanPresenceSensor2: ");  Console.print(read2);
...
void LoadAndLock() {
  ...
  if (doitall) {
    ...
    StopOpener();
    ///  unlock();
    // set arm and tower in position to receive the can
    Arm.write(165);
    Tower.write(70);
    Clamp.write(0);
...
void RunLoad() {
  ...
  while (Barrier1.read() < DesiredPosBarrier1) {
    ...
    Barrier1.write(pos);
    delay(Speed);
    //Console.println("Barrier1Loop1");
  }
  while (Barrier1.read() > DesiredPosBarrier1) {
    pos--;
    Barrier1.write(pos);
    delay(Speed);
    //Console.println("Barrier1Loop2");
  }
  ServoIsDone = true;
}
...
boolean CanPresence() {
  ...
  Console.println("");
  Console.print("CanPresence: "); Console.print(yesno);

  /*
    Console.println("");
    Console.print("Sensor Read: "); Console.print(analogRead(CanPresenceSensor1));
  */
...
boolean IsPressed()
{
  ...
  Console.println("");
  Console.print("Lock sensor pressed: "); Console.print(yesno);
...
void Catch() {
  ...
  int WristdesiredPos =  WristCatch;
